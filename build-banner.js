...
var doc = [
  ...
  '  <style>',
  '    :root { color: ' + config.primary + '; background-color: currentcolor; max-width: 100% }',
  '    body { margin: 0 }',
  '    path { fill: none; stroke: ' + config.secondary + '; stroke-width: 5px; stroke-linecap: round }',
  '    path:nth-child(odd) { stroke: ' + config.tertiary + ' }',
  '  </style>',
